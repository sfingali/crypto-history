...
This is the **first binary encoding of the alphabet in Western cryptography** and a direct ancestor of modern digital encoding. Bacon's genius was recognising that *any medium* with two distinguishable states can carry text — a principle Wilkins exploits for his bell, torch, and cannon systems in [[ch-17-joining-secrecy-swiftness-sound|Chapters 17]] and [[ch-20-polybius-torch-cipher|20]].

## Connections

- [[bacon-francis]] — Bacon's biography and full works
- [[ch-9-barbarous-words]] — Wilkins's full treatment of the binary alphabet
- [[polybius-cipher]] — another coordinate-based encoding system
